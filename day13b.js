...
function simulate()
{
	...
	return { severity: severity, collisions: collisions };
}
...
do
{
	...
	if (delay % 1000 == 0)
		console.log(result.collisions + ' collisions at delay ' + delay);
} while (result.collisions != 0);
